...
data_root = '/netscratch/jalal/marunet/datasets/Huh7/'
INF = 1e8
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/netscratch/jalal/marunet/json_cells_data/Huh7_train.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file='/netscratch/jalal/marunet/json_cells_data/Huh7_val.json',
    ...
    test=dict(
        type=dataset_type,
        ann_file='/netscratch/jalal/marunet/json_cells_data/Huh7_test.json',
