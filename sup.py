...
data_root = '/netscratch/jalal/marunet/datasets/A172/'
INF = 1e8
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/netscratch/jalal/marunet/json_cells_data/A172_train.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file='/netscratch/jalal/marunet/json_cells_data/A172_val.json',
